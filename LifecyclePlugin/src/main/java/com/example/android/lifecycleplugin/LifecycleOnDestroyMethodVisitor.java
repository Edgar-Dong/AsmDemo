...
public class LifecycleOnDestroyMethodVisitor extends MethodVisitor {
    ...
    public void visitCode() {
        super.visitCode();
        System.out.println(">>>>>" + LifecycleOnDestroyMethodVisitor.class.getSimpleName() + "visitCode");
    ...
    public void visitInsn(int opcode) {
        ...
        System.out.println(">>>>>" + LifecycleOnDestroyMethodVisitor.class.getSimpleName() + "visitInsn");
    }
}
