...
class LifecyclePlugin extends Transform implements Plugin<Project> {
    ...
    void apply(Project project) {
        println(">>>>>>>>>>apply project.name:" + project.name + ", project.version:" + project.version)
    ...
    @Override
    String getName() {
        String simpleName = LifecyclePlugin.simpleName;
        println(">>>>>>>>>>getName simpleName:" + simpleName)
        return simpleName
    }
    ...
    void transform(TransformInvocation transformInvocation) throws TransformException, InterruptedException, IOException {
        ...
        println("==========>>LifecyclePlugin visit begin<<==========")
        ...
        def cost = (System.currentTimeMillis() - beginTime)
        println("==========>>LifecyclePlugin visit end<<==========")
        println("LifecyclePlugin cost $cost ms")
    }
